...
- dashboard: core_metrics
  ...
  - title: Conversions Gauge
    ...
    filters:
      multisource_ads.set_conversions_goal: ''
    limit: 500
    column_limit: 50
    hidden_fields: []
    hidden_points_if_no: []
  ...
  - title: Cost Gauge
    ...
    explore: multisource_ads
    type: marketplace_viz_radial_gauge::radial_gauge-marketplace
    fields: [multisource_ads.spend, multisource_ads.cost_goal]
    filters:
      multisource_ads.set_cost_goal: ''
    limit: 500
    column_limit: 50
    hidden_fields: []
    hidden_points_if_no: []
  ...
  - title: Conversions Goal
    ...
    filters:
      multisource_ads.set_conversions_goal: ''
      multisource_ads.set_impressions_goal: '323'
    limit: 500
    column_limit: 50
    custom_color_enabled: true
    show_single_value_title: true
  ...
  - title: Cost Goal
    ...
    filters:
      multisource_ads.set_cost_goal: ''
      multisource_ads.set_impressions_goal: ''
    limit: 500
    column_limit: 50
    custom_color_enabled: true
    show_single_value_title: true
    ...
    conditional_formatting_include_totals: false
    conditional_formatting_include_nulls: false
    hidden_fields: [multisource_ads.spend]
    hidden_points_if_no: []
    series_labels: {}
    show_view_names: false
    arm_length: 25
