...
- dashboard: campaign_manager
  ...
  - name: ''
    ...
    body_text: |-
      ...
      <a style="padding: 5px 15px; border-bottom: solid 1px #4285F4; float: left; line-height: 40px;" href="/dashboards-next/pacing_block::campaign_comparison"> Marketing Campaign Comparison </a>
