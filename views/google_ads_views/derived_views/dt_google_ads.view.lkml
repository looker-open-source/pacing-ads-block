...
view: dt_google_ads {
  ...
  sql:
    ...
    WHERE (google_ads_campaign.campaign_status ) = 'ENABLED' AND (google_ads_customer._DATA_DATE = google_ads_customer._LATEST_DATE  AND google_ads_campaign._DATA_DATE = google_ads_campaign._LATEST_DATE  AND google_ads_group._DATA_DATE = google_ads_group._LATEST_DATE  AND google_ads_ad._DATA_DATE = google_ads_ad._LATEST_DATE ) AND (GAds.segments_ad_network_type NOT IN ('GAds - UNKNOWN','GAds - UNSPECIFIED') )
    GROUP BY
        1,
        2,
        3,
